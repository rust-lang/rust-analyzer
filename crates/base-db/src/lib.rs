...
impl EditionedFileId {
    ...
    #[inline]
    pub fn from_file_id(db: &dyn salsa::Database, file_id: FileId, edition: Edition) -> Self {
        EditionedFileId::new(db, span::EditionedFileId::new(file_id, edition))
    }

    #[inline]
    pub fn current_edition(db: &dyn salsa::Database, file_id: FileId) -> Self {
        EditionedFileId::new(db, span::EditionedFileId::new(file_id, Edition::CURRENT))
    }
