...
use ide_db::{
    EditionedFileId, FilePosition, FileRange, RootDatabase, base_db::RootQueryDb,
    span::Edition,
};
use syntax::{
    TextRange,
...
pub fn ssr_from_comment(
    ...
    let comment = {
        let span_file_id = ide_db::span::EditionedFileId::new(db, frange.file_id, Edition::CURRENT);
