...
use hir_ty::{
    ...
    next_solver::{
        AliasTy, DbInterner, EarlyBinder, ErrorGuaranteed, GenericArgs, ParamEnv, Ty, TyKind,
        TypingMode, infer::DbInternerInferExt,
    },
...
use crate::{
    ...
    Static, Struct, ToolModule, Trait, TupleField, Type, TypeAlias, TypeOwnerId,
    db::HirDatabase,
