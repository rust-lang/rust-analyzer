...
fn add_variant_to_union(
    ...
    let mut src_change_builder = SourceChangeBuilder::new(range.file_id.file_id());
...
fn add_field_to_struct_fix(
    ...
    match field_list {
        Some(FieldList::RecordFieldList(field_list)) => {
            ...
            let mut src_change_builder = SourceChangeBuilder::new(struct_range.file_id.file_id());
