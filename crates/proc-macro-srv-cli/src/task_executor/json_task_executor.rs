//! JSON protocol task executor for legacy protocol support
...
pub(crate) struct JsonTaskExecutor;

impl TaskExecutor for JsonTaskExecutor {
        ...
        while let Some(req) = read_request()? {
            let res = match req {
                    ...
                    match span_mode {
                        ...
                        SpanMode::RustAnalyzer => msg::Response::ExpandMacroExtended({
                            ...
                            let macro_body = macro_body
                                .to_subtree_resolved(CURRENT_API_VERSION, &span_data_table);
                ...
                msg::Request::ApiVersionCheck {} => {
                    msg::Response::ApiVersionCheck(CURRENT_API_VERSION)
                }
