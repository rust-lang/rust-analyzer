...
use either::Either;
use hir::{
    Adt, AsAssocItem, AsExternAssocItem, CaptureKind, DropGlue, DynCompatibilityViolation,
    HasCrate, HasSource, HirDisplay, Layout, LayoutError, MethodViolationCode, Name, Semantics,
    Symbol, Trait, Type, TypeInfo, VariantDef, db::ExpandDatabase,
};
use ide_db::{
    RootDatabase,
