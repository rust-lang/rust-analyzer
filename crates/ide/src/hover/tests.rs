...
"#,
        expect![[r#"
            *Foo*
            ...
            no drop glue; doesn't have a destructor
        "#]],
    );
}
    ...
    check(
        ...
        expect![[r#"
            *_x*
            ...
            may have drop glue depending on type parameters
        "#]],
    )
}
...
"#,
        expect![[r#"
            *ST*
            ...
            may have drop glue depending on type parameters; doesn't have a destructor
        "#]],
    );
}
    ...
    "#,
        expect![[r#"
            *DropField*
            ...
            has drop glue; doesn't have a destructor
        "#]],
    );
    check(
        r#"
