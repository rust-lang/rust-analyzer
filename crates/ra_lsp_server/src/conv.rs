use lsp_types::{
    self, CreateFile, Documentation, DocumentChangeOperation, DocumentChanges, Location,
...
use ra_ide_api::{
    ...
    NavigationTarget, SourceChange, SourceFileEdit, RangeInfo, LineCol, LineIndex,
    translate_offset_with_edit, InsertTextFormat,
};
