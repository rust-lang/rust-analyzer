...
use lsp_types::{
    ...
    DidOpenTextDocumentParams, TextDocumentItem, TextDocumentPositionParams,
};
use ra_lsp_server::req::{
    CodeActionParams, CodeActionRequest, Formatting, Runnables, RunnablesParams, CompletionParams,
    Completion, DidOpenTextDocument, OnEnter,
};
use serde_json::json;
