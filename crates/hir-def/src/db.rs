    ...
    + Upcast<dyn RootQueryDb>
{
    ...
    #[db_ext_macro::invoke_actual(DefMap::block_def_map_query)]
    ...
    #[db_ext_macro::invoke_actual(StructData::struct_data_query)]
    fn struct_data(&self, id: StructId) -> Arc<StructData>;

    #[db_ext_macro::invoke_actual(StructData::struct_data_with_diagnostics_query)]
    fn struct_data_with_diagnostics(&self, id: StructId) -> (Arc<StructData>, DefDiagnostics);

    #[db_ext_macro::transparent]
    #[db_ext_macro::invoke_actual(StructData::union_data_query)]
    fn union_data(&self, id: UnionId) -> Arc<StructData>;

    #[db_ext_macro::invoke_actual(StructData::union_data_with_diagnostics_query)]
    fn union_data_with_diagnostics(&self, id: UnionId) -> (Arc<StructData>, DefDiagnostics);

    #[db_ext_macro::invoke_actual(EnumData::enum_data_query)]
    fn enum_data(&self, e: EnumId) -> Arc<EnumData>;

    #[db_ext_macro::transparent]
    #[db_ext_macro::invoke_actual(EnumVariantData::enum_variant_data_query)]
    fn enum_variant_data(&self, id: EnumVariantId) -> Arc<EnumVariantData>;

    #[db_ext_macro::invoke_actual(EnumVariantData::enum_variant_data_with_diagnostics_query)]
    ...
    #[db_ext_macro::transparent]
    #[db_ext_macro::invoke_actual(VariantData::variant_data)]
    fn variant_data(&self, id: VariantId) -> Arc<VariantData>;
    #[db_ext_macro::transparent]
    #[db_ext_macro::invoke_actual(ImplData::impl_data_query)]
    ...
    #[db_ext_macro::transparent]
    #[db_ext_macro::invoke_actual(TraitData::trait_data_query)]
    ...
    #[db_ext_macro::invoke_actual(TraitAliasData::trait_alias_query)]
    fn trait_alias_data(&self, e: TraitAliasId) -> Arc<TraitAliasData>;

    #[db_ext_macro::invoke_actual(TypeAliasData::type_alias_data_query)]
    fn type_alias_data(&self, e: TypeAliasId) -> Arc<TypeAliasData>;

    #[db_ext_macro::invoke_actual(FunctionData::fn_data_query)]
    fn function_data(&self, func: FunctionId) -> Arc<FunctionData>;

    #[db_ext_macro::invoke_actual(ConstData::const_data_query)]
    fn const_data(&self, konst: ConstId) -> Arc<ConstData>;

    #[db_ext_macro::invoke_actual(StaticData::static_data_query)]
    fn static_data(&self, statik: StaticId) -> Arc<StaticData>;

    #[db_ext_macro::invoke_actual(Macro2Data::macro2_data_query)]
    fn macro2_data(&self, makro: Macro2Id) -> Arc<Macro2Data>;

    #[db_ext_macro::invoke_actual(MacroRulesData::macro_rules_data_query)]
    fn macro_rules_data(&self, makro: MacroRulesId) -> Arc<MacroRulesData>;

    #[db_ext_macro::invoke_actual(ProcMacroData::proc_macro_data_query)]
    fn proc_macro_data(&self, makro: ProcMacroId) -> Arc<ProcMacroData>;

    #[db_ext_macro::invoke_actual(ExternCrateDeclData::extern_crate_decl_data_query)]
    ...
    #[db_ext_macro::invoke_actual(GenericParams::generic_params_query)]
    fn generic_params(&self, def: GenericDefId) -> Arc<GenericParams>;

    /// If this returns `None` for the source map, that means it is the same as with the item tree.
    #[db_ext_macro::invoke_actual(GenericParams::generic_params_with_source_map_query)]
    ...
    #[db_ext_macro::invoke_actual(Attrs::fields_attrs_query)]
    ...
    #[db_ext_macro::invoke_actual(visibility::function_visibility_query)]
    fn function_visibility(&self, def: FunctionId) -> Visibility;

    #[db_ext_macro::invoke_actual(visibility::const_visibility_query)]
