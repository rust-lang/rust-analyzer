...
use hir::{
    AsAssocItem, AssocItem, AssocItemContainer, Crate, DoNotComplete, HasCrate, ImportPathConfig,
...
pub struct LocatedImport {
    ...
    /// The value of `#[rust_analyzer::do_not_complete(...)]`, if existing.
        ...
        [] => {
            ...
            .filter_map(|(item, do_not_complete)| {
                ...
                Some(LocatedImport::new(
                    ...
                    item,
                    item,
                    CompleteInFlyimport(do_not_complete != DoNotComplete::Flyimport),
                ))
            })
...
fn trait_applicable_items(
    ...
    .filter_map(|(assoc, do_not_complete)| {
        ...
        required_assoc_items
            .insert(assoc, CompleteInFlyimport(do_not_complete != DoNotComplete::Flyimport));
