...
impl Request for InternalTestingFetchConfigRequest {
    ...
    const METHOD: LspRequestMethod = LspRequestMethod::Custom(Cow::Borrowed(
        "rust-analyzer-internal/internalTestingFetchConfig",
    ));
...
impl Request for AnalyzerStatusRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/analyzerStatus"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for FetchDependencyListRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/fetchDependencyList"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for MemoryUsageRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/memoryUsage"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ReloadWorkspaceRequest {
    ...
    type Result = ();
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/reloadWorkspace"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for RebuildProcMacrosRequest {
    ...
    type Result = ();
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/rebuildProcMacros"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewSyntaxTreeRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewSyntaxTree"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewHirRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewHir"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewMirRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewMir"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for InterpretFunctionRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/interpretFunction"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewFileText {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewFileText"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewCrateGraphRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewCrateGraph"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewItemTreeRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewItemTree"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for DiscoverTestRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/discoverTest"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for DiscoveredTestsNotification {
    ...
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("experimental/discoveredTests"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for RunTestRequest {
    ...
    type Result = ();
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/runTest"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for EndRunTestNotification {
    type Params = ();
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("experimental/endRunTest"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for AppendOutputToRunTestNotification {
    type Params = String;
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("experimental/appendOutputToRunTest"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for AbortRunTestNotification {
    type Params = ();
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("experimental/abortRunTest"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for ChangeTestStateNotification {
    ...
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("experimental/changeTestState"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ExpandMacroRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/expandMacro"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ViewRecursiveMemoryLayoutRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/viewRecursiveMemoryLayout"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for CancelFlycheckNotification {
    type Params = ();
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("rust-analyzer/cancelFlycheck"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for RunFlycheckNotification {
    ...
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("rust-analyzer/runFlycheck"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for ClearFlycheckNotification {
    type Params = ();
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("rust-analyzer/clearFlycheck"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for OpenServerLogsNotification {
    type Params = ();
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("rust-analyzer/openServerLogs"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for MatchingBraceRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/matchingBrace"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ChildModulesRequest {
    ...
    type Result = Option<lsp_types::DefinitionResponse>;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/childModules"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for JoinLinesRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/joinLines"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for OnEnterRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/onEnter"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for RunnablesRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/runnables"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for RelatedTestsRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/relatedTests"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for SsrRequest {
    ...
    const METHOD: LspRequestMethod = LspRequestMethod::Custom(Cow::Borrowed("experimental/ssr"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Notification for ServerStatusNotification {
    ...
    const METHOD: LspNotificationMethod =
        LspNotificationMethod::Custom(Cow::Borrowed("experimental/serverStatus"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for CodeActionRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("textDocument/codeAction"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for CodeActionResolveRequest {
    ...
    const METHOD: LspRequestMethod = LspRequestMethod::Custom(Cow::Borrowed("codeAction/resolve"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for ExternalDocsRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/externalDocs"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for OpenCargoTomlRequest {
    ...
    type Result = Option<lsp_types::DefinitionResponse>;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/openCargoToml"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for MoveItemRequest {
    ...
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("experimental/moveItem"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for WorkspaceSymbolRequest {
    ...
    const METHOD: LspRequestMethod = LspRequestMethod::Custom(Cow::Borrowed("workspace/symbol"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for DocumentOnTypeFormattingRequest {
    ...
    type Result = Option<Vec<SnippetTextEdit>>;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("textDocument/onTypeFormatting"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for GetFailedObligationsRequest {
    ...
    type Result = String;
    const METHOD: LspRequestMethod =
        LspRequestMethod::Custom(Cow::Borrowed("rust-analyzer/getFailedObligations"));
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
