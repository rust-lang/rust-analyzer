...
/// they would be written in source, because no editor gesture points at a pair
/// of an item and a module the way dragging a file points at a module and its
/// new parent — see [`lsp_types::WillRenameFilesRequest`].
