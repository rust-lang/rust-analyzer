...
pub(crate) fn replace_turbofish_with_explicit_type(
    ...
    let initializer_start = initializer.syntax().text_range_without_outer_trivia().start();
    ...
    if let_stmt.colon_token().is_none() {
        ...
        // let x = fn::<...>();
        let ident_range = let_stmt.pat()?.syntax().text_range_without_outer_trivia();
        ...
        // the turbofish.
        // let x: _ = fn::<...>();
        let underscore_range = t.syntax().text_range_without_outer_trivia();
