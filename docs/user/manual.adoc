...
=== multilspy
https://github.com/microsoft/monitors4codegen[microsoft/monitors4codegen] provides `multilspy`, a lsp client library in Python intended to be used to build applications around language servers and communicate programatically with language servers. It offers installation and usage bindings for rust-analyzer. Example usage can be found in https://github.com/microsoft/monitors4codegen/blob/main/tests/multilspy/test_sync_multilspy_rust.py[multilspy-rust-unittest].
