...
mod tests {
    ...
    #[cfg(not(feature = "bsp"))]
    static INITIALIZE: &str = "initialize";
    #[cfg(not(feature = "bsp"))]
    static EXIT: &str = "exit";

    #[cfg(feature = "bsp")]
    static INITIALIZE: &str = "build/initialize";
    #[cfg(feature = "bsp")]
    static EXIT: &str = "build/exit";
    ...
    fn exit_notification() {
        let notification =
            crate::Notification { method: EXIT.into(), params: to_value(()).unwrap() };
