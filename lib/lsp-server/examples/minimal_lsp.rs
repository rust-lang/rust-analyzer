...
//! =============================================================
//!
//!Expanding on examples/goto_def.rs, this self-contained example showcases a complete LSP workflow—covering completion,
//! hover, formatting, and diagnostics—in roughly 200 lines of clear, well-commented code.
//!
...
//! cargo add anyhow --dev         # once, only for examples
