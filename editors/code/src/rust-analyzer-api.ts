...
export const findMatchingBrace = request<FindMatchingBraceParams, Vec<lc.Position>>(
    'findMatchingBrace',
);
...
export const decorationsRequest = request<lc.TextDocumentIdentifier, Vec<Decoration>>(
    'decorationsRequest',
);

export const parentModule = request<lc.TextDocumentPositionParams, Vec<lc.Location>>(
    'parentModule',
);
